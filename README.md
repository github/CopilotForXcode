...
Use of the GitHub Copilot Xcode Extension is subject to [GitHub's Pre-Release Termsp](https://docs.github.com/en/site-policy/github-terms/github-pre-release-license-terms). We want to remind you that:
